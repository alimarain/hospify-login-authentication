...
// import 'screens/auth_screen.dart';
// import 'screens/nurse_dashboard_screen.dart';
// import 'screens/doctor_dashboard.dart';
// import 'screens/dashboard_screen.dart';
// import 'providers/auth_provider.dart';
...
// class Hospify extends ConsumerWidget {
//   const Hospify({super.key});
...
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:hospify/screens/auth_screen.dart';
import 'package:supabase_flutter/supabase_flutter.dart';
...
class Hospify extends ConsumerWidget {
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    // Watch dark mode setting from settingsProvider
...
//   runApp(const ProviderScope(child: Hospify()));
// }
...
//     switch (authState.userRole!) {
//       case app.UserRole.nurse:
//         return const MainLayout(child: NursesDashboardScreen());
//       case app.UserRole.doctor:
//         return const MainLayout(child: DoctorsDashboardScreen());
//       case app.UserRole.admin:
//         return const MainLayout(child: DashboardScreen());
//     }
//   }
...
// /// Responsive layout wrapper using AppTheme colors
// class MainLayout extends StatelessWidget {
//   final Widget child;
//   const MainLayout({super.key, required this.child});
...
//       body: Row(
//         children: [
//           if (!isMobile) SizedBox(width: 250, child: SideBar()),
//           Expanded(
//             child: Container(
