...
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:hospify/utils/app_colors%20copy.dart'; // Make sure this path is correct in your project
import 'package:hospify/utils/responsive_utils.dart';
import '../models/auth_model.dart';
import '../providers/auth_provider.dart';
import '../widgets/role_tab.dart';
  ...
  Future<void> _handleSubmit() async {
    ...
    if (success && mounted) {
      ...
      switch (authState.userRole) {
        case UserRole.nurse:
          // ✅ Wrap in MainLayout
          dashboard = const MainLayout(child: NurseDashboard());
          break;
        case UserRole.doctor:
          // ✅ Wrap in MainLayout
          dashboard = const MainLayout(child: DoctorDashboard());
          break;
        case UserRole.admin:
          // ✅ Wrap in MainLayout (Assuming DashboardScreen is just content)
          // If DashboardScreen has its own sidebar, use: dashboard = const DashboardScreen();
          dashboard = const MainLayout(child: DashboardScreen());
          break;
        default:
          return;
      }
